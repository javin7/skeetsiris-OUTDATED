...
void Config::load(size_t id) noexcept
{
...

    {
        ...
        if (visualsJson.isMember("Rainbow crosshair")) visuals.rainbowCrosshair = visualsJson["Rainbow crosshair"].asBool();
        if (visualsJson.isMember("Rainbow crosshair speed")) visuals.rainbowCrosshairSpeed = visualsJson["Rainbow crosshair speed"].asFloat();  
...

    {
        ...
        if (miscJson.isMember("showVelocity")) misc.showVelocity = miscJson["showVelocity"].asBool();
        ...
        if (miscJson.isMember("Jump Bug")) misc.jumpbug = miscJson["JumpBug"].asBool();
        if (miscJson.isMember("Jump Buf Key")) misc.jumpbugkey = miscJson["Jump Bug Key"].asInt();
...
void Config::save(size_t id) const noexcept
{
...

    {
        ...
        visualsJson["Rainbow crosshair speed"] = visuals.rainbowCrosshair;
        visualsJson["Rainbow crosshair speed"] = visuals.rainbowCrosshairSpeed;
...

    {
        ...
        miscJson["noVelocity"] = misc.showVelocity;
        ...
        miscJson["Block Bot Key"] = misc.blockBotKey;
