...
void GUI::renderRemovalWindow() noexcept
{
...
void GUI::renderVisualsWindow() noexcept
{
    ...
    ImGui::SliderFloat("", &config->visuals.rainbowCrosshairSpeed, 0.0f, 25.0f, "%.2f");
    ImGui::PopItemWidth();
...
//    ImGui::Checkbox("Debooger window", &config->misc.debugwindow);
    ...
    ImGui::Checkbox("Show velocity", &config->misc.showVelocity);
...
void GUI::renderGui() noexcept
{
    ...
    ImGui::Begin("Javin", nullptr, windowFlags);
        ...
        ImGui::BeginChild("##Back", ImVec2{ 704, 434 }, false);
        {
            ...
            ImGui::BeginChild("##Main", ImVec2{ 700, 430 }, false);
            {
                ImGui::BeginChild("##UP", ImVec2{ 700, 45 }, false);
                {
                    ...
                    ImGui::PushFont(fonts.tahoma34); ImGui::Text("Javin"); ImGui::PopFont();
                ...
                ImGui::BeginChild("##Childs", ImVec2{ 700, 365 }, false);
                {
                    ...
                    ImGui::BeginChild("##Left", ImVec2{ 155, 320 }, false);
                    {
                        ...
                        else if (Active_Tab == 5)
                        {
                            ...
                            if (ImGui::Button("Sound                   ", ImVec2{ 80, 20 })) Active_SubTabMisc = 2;

                            if (ImGui::Button("Style                   ", ImVec2{ 80, 20 })) Active_SubTabMisc = 3;
                        }
